...
{ 
    ...
    cout << "\nDecimal number: " << num 
  	...
  	bitset<4> bset11(9); // bset1 contains 1001 
    bitset<4> bset22(3); // bset2 contains 0011 
  
    // comparison operator 
    cout << (bset11 == bset22) << endl; // false 0 
    cout << (bset11 != bset22) << endl; // true  1 
  
    // bitwise operation and assignment 
    cout << (bset11 ^= bset22) << endl; // 1010 
    cout << (bset11 &= bset22) << endl; // 0010 
    cout << (bset11 |= bset22) << endl; // 0011 
  
    // left and right shifting 
    cout << (bset11 <<= 2) << endl; // 1100 
    cout << (bset11 >>= 1) << endl; // 0110 
  
    // not operator 
    cout << (~bset22) << endl; // 1100 
  
    // bitwise operator 
    cout << (bset11 & bset22) << endl; // 0010 
    cout << (bset11 | bset22) << endl; // 0111 
    cout << (bset11 ^ bset22) << endl; // 0101
    return 0; 
} 
